...
- Procedural material traits now produce live shader-layer plans, deterministic texture bake manifests, pure RGBA raster payloads, and dependency-free PNG bytes for adapter or offline asset pipelines.
