...
- Procedural material traits now produce live shader-layer plans, deterministic texture bake manifests, and pure RGBA raster payloads for adapter or offline asset pipelines.
