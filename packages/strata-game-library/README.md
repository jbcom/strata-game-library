...
- Prop interaction execution returns deterministic UI/audio/inventory/command/physics/state effect records for adapter-owned gameplay flows, with an R3F controller hook plus R3F and Babylon helpers for applying prop physics effects to runtime object metadata and Babylon collision/pickability state.
