...
- Prop interaction execution returns deterministic UI/audio/inventory/command/physics/state effect records for adapter-owned gameplay flows, with R3F and Babylon helpers now applying prop physics effects to runtime object metadata and Babylon collision/pickability state.
