...
- `RuntimeProp` and `RuntimeCreature` render resolved core composition runtime plans in R3F, with material overrides and custom node/bone renderers for asset-backed meshes.
