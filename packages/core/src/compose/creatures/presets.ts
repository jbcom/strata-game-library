/**
 * Built-in creature preset definitions.
 *
 * Presets are plain data: they name a skeleton and covering, and carry stats,
 * AI, animation names, spawn rules, drops, and sounds. `createCreature` merges
 * user input over an entry here.
 *
 * @module CreaturePresets
