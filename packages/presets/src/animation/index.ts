...
import type { GaitConfig, LookAtConfig, SpringConfig } from '@strata-game-library/core';
...
export function blendSpringPresets(
  ...
  return {
    stiffness:
      preset1.config.stiffness + (preset2.config.stiffness - preset1.config.stiffness) * clampedT,
