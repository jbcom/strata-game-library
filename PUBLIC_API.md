...
The R3F adapter consumes those plans through `RuntimeProp` and `RuntimeCreature`, with override hooks for custom node/bone renderers and custom Three.js materials.
