  ...
  var ae = Me((se, oe) => {
    (function () {
      ...
      (t.tokenizer = (e, n) => {
        ...
        if (Array.isArray(e))
          return e.map((y) => new t.Token(t.utils.asString(y).toLowerCase(), t.utils.clone(n)));
...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              for (var S = 0; S < L.length; S++)
                for (
                  ...
                  if ((i[m].upsert(_, u.boost, (Qe, Ie) => Qe + Ie), !s[j])) {
          ...
          return v.sort((Te, ke) => ke.score - Te.score);
        }),
...
`),
  ...
  function we(t, e, n) {
    ...
    if (t.children) {
      ...
      for (const u of t.children) we(u, l, i);
    } else Ee(t, r, t.class);
  }
  function Ee(t, e, n) {
    if (t.path) {
