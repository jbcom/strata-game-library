...
import { updateBillboardRotation } from '@strata-game-library/core';
import { calculateImpostorAngle, createImpostorGeometry, updateImpostorUV } from '@strata-game-library/core';
