...
import { calculateLookAhead, smoothDampVector3 } from '@strata-game-library/core';
...
export const FollowCamera = forwardRef<FollowCameraRef, FollowCameraProps>(
  (
    ...
    return (
      <PerspectiveCamera ref={cameraRef} fov={fov} makeDefault={makeDefault} position={offset} />
    );
  }
);
