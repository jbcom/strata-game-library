...
export function GyroscopeCamera({
  ...
  useFrame((_state, delta) => {
    ...
    const offsetX =
      dist * Math.sin(cameraRotation.current.azimuth) * Math.cos(cameraRotation.current.elevation);
    const offsetY = dist * Math.sin(cameraRotation.current.elevation);
    const offsetZ =
      dist * Math.cos(cameraRotation.current.azimuth) * Math.cos(cameraRotation.current.elevation);
