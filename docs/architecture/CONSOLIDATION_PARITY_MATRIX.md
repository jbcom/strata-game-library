...
| `examples` | Private `@strata/examples@1.0.0` | `apps/examples` | Migrated and expanded | Expand current dependency/import/bundle verification into browser runtime checks |
...
2. Expand `apps/examples` verification beyond current package/import/bundle checks into browser runtime smoke coverage.
