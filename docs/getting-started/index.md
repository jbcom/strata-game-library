...
- [Installation](https://strata.game/getting-started/installation/) - Set up Strata in your project
- [Quick Start](https://strata.game/getting-started/quick-start/) - Build your first scene in 5 minutes
- [Architecture](https://strata.game/getting-started/architecture/) - Understand how Strata is organized
- [Live Demos](https://strata.game/showcase/) - See Strata in action
