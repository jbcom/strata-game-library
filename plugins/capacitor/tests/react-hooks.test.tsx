...
describe('React hooks', () => {
  ...
  describe('useStrata', () => {
    it('should fetch device info and safe area on mount', async () => {
      ...
      function TestComponent() {
        ...
        return <div data-testid="strata-info">{deviceInfo?.platform ?? 'loading'}</div>;
      }
  ...
  describe('useDevice', () => {
    ...
    it('DeviceProvider should register deviceChange listener', async () => {
      ...
      await waitFor(() => {
        expect(mockedStrata.addListener).toHaveBeenCalledWith('deviceChange', expect.any(Function));
      });
    });
  });
  ...
  describe('useInput', () => {
    ...
    it('InputProvider should register inputChange listener', async () => {
      ...
      await waitFor(() => {
        expect(mockedStrata.addListener).toHaveBeenCalledWith('inputChange', expect.any(Function));
      });
    });
